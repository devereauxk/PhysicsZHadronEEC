...
OFFICIAL_PP_NOEE_RESULT_PREFIX="${OFFICIAL_RESULT_DIR}/pp_trkResidual_${OFFICIAL_TAG_PP}_noEE"
export OFFICIAL_PP_RESULT_PREFIX OFFICIAL_PP_NOEE_RESULT_PREFIX OFFICIAL_PPB_NOSUB_PREFIX OFFICIAL_PBP_NOSUB_PREFIX

# Signed track-pT scan prefixes (ZPT0_500, trkPT={0.5_2, 2_4, 4_15})
OFFICIAL_PP_RESULT_PREFIX_SCAN="${OFFICIAL_RESULT_DIR}/pp_trkResidual_${OFFICIAL_TAG_PP}_scan"
OFFICIAL_PPB_NOSUB_PREFIX_SCAN="${OFFICIAL_RESULT_DIR}/pPb_trkResidual_${OFFICIAL_TAG_PPB}_scan"
OFFICIAL_PBP_NOSUB_PREFIX_SCAN="${OFFICIAL_RESULT_DIR}/PbP_trkResidual_${OFFICIAL_TAG_PPB}_scan"
export OFFICIAL_PP_RESULT_PREFIX_SCAN OFFICIAL_PPB_NOSUB_PREFIX_SCAN OFFICIAL_PBP_NOSUB_PREFIX_SCAN
