...
for zpt_range in "${ZPT_RANGES[@]}"; do
    ...
    #myfile="plots/PbPb0_30_ZPT$zpt_range-nosub.root,plots/DY0_30_ZPT$zpt_range-nosub.root,plots/jewelPbPb030_ZPT$zpt_range-nosub.root,plots/hybridPbPb030_ZPT$zpt_range-nosub.root,plots/pp_ZPT$zpt_range-nosub.root,plots/pythia_ZPT$zpt_range-nosub.root,plots/jewelPP_ZPT$zpt_range-nosub.root,plots/hybridPP_ZPT$zpt_range-nosub.root"
    myfile="plots/jewelPbPb030_ZPT$zpt_range-nosub.root,plots/hybridPbPb030_ZPT$zpt_range-nosub.root,plots/jewelPP_ZPT$zpt_range-nosub.root,plots/hybridPP_ZPT$zpt_range-nosub.root"
    #curvelabels="PbPb@0-30%","PythiaDY","Jewel@v2.2.0","Hybrid"
    curvelabels="Jewel@v2.2.0","Hybrid"
    ...
    ./ExecuteDiff --PlotDiff 1 --ExtraInfo $extraInfoPhi --Markers $markers --Colors $colors --XAxisLabel "#Delta#phi_{lead,Z}" --YAxisLabel "(1/N_{Z})dN_{lead}/d#phi_{lead,Z}" --SolidXMin 0 --SolidXMax 3.1415926 --XMin -1.5758 --XMax 4.7275 --Rebin 1 --ToPlot DeltaPhi --DataFiles $myfile --SkipSystematics true --YMin 0 --YMax 1 --RMin 0 --RMax 5 --OutputBase summary/nosub-DeltaPhi-Diff0_30_ZPT$zpt_range --CurveLabels $curvelabels --lines 0,1,2,2,1,2,1,2 --Tags $tags --Labels $labels

    ./ExecuteDiff --PlotDiff 1 --ExtraInfo $extraInfoEta --Markers $markers --Colors $colors --XAxisLabel "#Deltay_{lead,Z}" --YAxisLabel "(1/N_{Z})dN_{lead}/d#Delta y_{lead,Z}" --SolidXMin 0 --SolidXMax 3.9999 --XMin -3.999 --XMax 3.9999 --Rebin 1 --ToPlot DeltaEta --DataFiles $myfile --SkipSystematics true --YMin 0 --YMax 0.9 --RMin 0 --RMax 3 --OutputBase summary/nosub-DeltaEta-Diff0_30_ZPT$zpt_range --CurveLabels $curvelabels --lines 0,1,2,2,1,2,1,2 --Tags $tags --Labels $labels
