...
GEN_FILE="$ZCORR_DIR/output/closure_inputs/pPb_${INPUT_TAG}_zPt0-500_gen.root"
RECO_FILE="$ZCORR_DIR/output/closure_inputs/pPb_${INPUT_TAG}_zPt0-500_reco.root"
