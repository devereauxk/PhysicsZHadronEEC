...
void plot_closure() {
    ...
    vector<string> input_ZPT_files = {
        "/home/kdeverea/PhysicsZHadronEEC/MainAnalysis/20241102_ZhadronVsZPt/plots/pPbMC_Gen_nominal_ZPT0_100-result.root",
        "/home/kdeverea/PhysicsZHadronEEC/MainAnalysis/20241102_ZhadronVsZPt/plots/pPbMC_nominal_ZPT0_100-result.root",
        "/home/kdeverea/PhysicsZHadronEEC/MainAnalysis/20241102_ZhadronVsZPt/plots/pPbMC_Gen_nominal_noEPOS_ZPT0_100-result.root",
        "/home/kdeverea/PhysicsZHadronEEC/MainAnalysis/20241102_ZhadronVsZPt/plots/pPbMC_residual_ZPT0_100-result.root"
    };
    ...
    const char* output =  "plots/pPb_ZPT0_100-0.5_10";
    ...
    TPad* pTrk1 = (TPad*) plotCMSRatio(
        ...
        "p_{T}^{ch}", 0, 11,
        "(1/N_{Z}) dN_{ch}/dp_{T}^{ch}", 1e-2, 1e2,
        "Ratio to Gen+EPOS", 0.75, 1.25,
        0,
        false, true, false
    );
