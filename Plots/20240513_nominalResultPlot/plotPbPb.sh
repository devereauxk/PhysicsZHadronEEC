...
myfile="plots/PbPb0_30-result.root,plots/DY0_30-result.root,plots/jewelPbPb030-result.root,plots/hybridPbPb030-result.root,plots/pyquenPbPb030-result.root,plots/pp-result.root,plots/pythia-result.root,plots/jewelPP-result.root,plots/hybridPP-result.root,plots/pyquenPP-result.root"
...
label="PbPb@0-30%","PYTHIA8","Jewel@v2.2.0","Hybrid","PYQUEN"
...
./ExecuteDiff --ExtraInfo $extraInfoPhi --Markers $markers --Colors $colors --XAxisLabel "#Delta#phi_{ch,Z}" --YAxisLabel "d#LT#DeltaN_{ch}#GT/d#Delta#phi_{ch,Z}" --SolidXMin 0 --SolidXMax 3.1415926 --XMin -1.5758 --XMax 4.7275 --Rebin 1 --ToPlot DeltaPhi --DataFiles $myfile --SkipSystematics true --YMin -2.5 --YMax 4.5 --RMin -2.5 --RMax 2.5 --OutputBase summary/result-DeltaPhi-PbPb0_30MC --CurveLabels $label --lines 0,1,2,2,1,2,1,2
