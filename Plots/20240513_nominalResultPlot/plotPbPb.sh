...
myfile="plots/PbPb0_30-result.root,plots/hybridPbPb030-result.root,plots/pyquenPbPb030-result.root,plots/jewelPbPb030-result.root,plots/pp-result.root,plots/hybridPP-result.root,plots/pyquenPP-result.root,plots/jewelPP-result.root"
...
label="PbPb@0-30%","Hybrid","PYQUEN","Jewel@v2.2.0"
