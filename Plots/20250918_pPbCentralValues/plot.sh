...
colors=1181,1179,1183,1180,1180,7,1,97,0,1184,1185,1186,1187,1188
...
for zpt_range in "${ZPT_RANGES[@]}"; do
    ...
    myfile="plots/pPbPbP_nominal_yboost_ZPT$zpt_range-result.root,plots/pPbPbPMC_nominal_yboost_ZPT$zpt_range-result.root,plots/pPbPbPMC_Gen_nominal_yboost_ZPT$zpt_range-result.root,plots/pp_nominal_yboost_ZPT$zpt_range-result.root,plots/pp_nominal_yboost_ZPT$zpt_range-result.root,plots/pp_nominal_yboost_ZPT$zpt_range-result.root"
    curvelabels="pPb@data,pPbMC@reco,pPbMC@gen+EPOS"
    outputtag="20251020_pPbPbP"
