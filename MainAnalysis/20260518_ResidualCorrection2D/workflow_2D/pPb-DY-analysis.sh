...
minZpt="${1:-0}"
maxZpt="${2:-500}"
name="${3:-${NAME_TAG:-20260518_2DResidual_TrackResidualCorrection}}"
if [ "$#" -ge 3 ]; then
    shift 3
else
    shift "$#"
...
root -l -q -b "merge_corrections_2D.C(\"output/correction_1.root\",\"output/correction_2.root\",\"output/correction_12.root\")"
...
root -l -q -b plot_corrections_2D.C
mv corrections_2D.pdf "plots/corrections_2D_PPb_${name}${VARIANT_SUFFIX}_${minZpt}_${maxZpt}.pdf"
root -l -q -b "merge_corrections_2D.C(\"output/correction_12.root\",\"output/correction_3.root\",\"${ppb_output}\")"
...
root -l -q -b "plot_closure.C(\"plots/closure_PPb_${name}${VARIANT_SUFFIX}_${minZpt}_${maxZpt}\")"
...
mv correction.root output/correction_3.root
root -l -q -b plot_corrections_2D.C
mv corrections_2D.pdf "plots/corrections_2D_PbP_${name}${VARIANT_SUFFIX}_${minZpt}_${maxZpt}.pdf"
root -l -q -b "merge_corrections_2D.C(\"output/correction_12.root\",\"output/correction_3.root\",\"${pbp_output}\")"
...
root -l -q -b "plot_closure.C(\"plots/closure_PbP_${name}${VARIANT_SUFFIX}_${minZpt}_${maxZpt}\")"
