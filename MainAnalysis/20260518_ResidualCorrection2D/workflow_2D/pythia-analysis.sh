...
mv corrections_2D.pdf "plots/corrections_2D_pp_${name}${VARIANT_SUFFIX}_${minZpt}_${maxZpt}.pdf"
root -l -q -b "merge_corrections_2D.C(\"output/correction_12.root\",\"output/correction_3.root\",\"${output_file}\")"
