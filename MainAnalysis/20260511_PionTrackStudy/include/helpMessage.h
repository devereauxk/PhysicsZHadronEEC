        ...
        if (arg == "--help") {
           std::cout << "Usage: " << argv[0] << " [OPTIONS]\n"
              ...
              << "  --IsPUReject           Flag to reject PU sample for systematics.\n"
               ...
               << "  --UseJackknife         Persist per-event contributions and replace final data statistical errors with jackknife.\n"
               << "  --UsePionTrackY        Use the skimmed pion-mass track rapidity instead of track eta in the longitudinal observable.\n"
               << "  --ResultDEtaBins <value>   Result-stage #Delta#eta bins (maintained values: 20 official, 10 shifted, 12 modified).\n"
               << "  --ResultDPhiBins <value>   Result-stage #Delta#phi bins (maintained values: 20 official, 10 shifted, 12 modified).\n"
