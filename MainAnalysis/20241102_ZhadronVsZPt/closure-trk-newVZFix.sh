...
export RUN_GEN=${RUN_GEN:-1}
export RUN_NOMINAL=${RUN_NOMINAL:-1}
export RUN_ZRESIDUAL=${RUN_ZRESIDUAL:-1}
export RUN_TRKRESIDUAL=${RUN_TRKRESIDUAL:-1}
