...
run_pap_chain() {
    ...
    ./system-analysis.sh "${MCPREFIX}_nominal${TAG}" \
        --IsPP false --IsGenZ false --IsData false --IsPPb ${ISPPB} \
        --Input ${MCINPUT} \
        --MixFile ${MCINPUT} \
        --UseEventWeight true --UseZWeight false \
        --UseTrackWeight true --UseResidualWeight false \
...
if [ "${DOPP}" == "1" ]; then
    run_pp_chain "_myEvtWeight_VZOnly_nmix1" true true \
        "/home/kdeverea/PhysicsZHadronEEC/Plots/20251001_pPbVZReweighting/summary/20260317_ZV6_ZPT0_350_VzReweightFits_pp.root"
...
if [ "${DOPPB}" == "2" ]; then
    run_pap_chain "pPbMC" "pPb" true \
        ...
        "pPbSample/V0.2/PPbData_Reco.root" \
        "_VZWeight_nmix0" \
        "/home/kdeverea/PhysicsZHadronEEC/Plots/20251001_pPbVZReweighting/summary/20260311_ZPT0_500_VzReweightFits_pPb.root"
fi
...
if [ "${DOPBP}" == "2" ]; then
    run_pap_chain "PbPMC" "PbP" false \
        ...
        "pPbSample/V0.2/PbPData_Reco.root" \
        "_VZWeight_nmix0" \
        "/home/kdeverea/PhysicsZHadronEEC/Plots/20251001_pPbVZReweighting/summary/20260311_ZPT0_500_VzReweightFits_PbP.root"
fi
