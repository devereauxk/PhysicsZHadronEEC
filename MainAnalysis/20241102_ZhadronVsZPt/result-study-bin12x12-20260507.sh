...
STUDY_SUFFIX="${STUDY_SUFFIX:-_bin12x12_20260603}"
PP_TAG="${PP_TAG_OVERRIDE:-${OFFICIAL_TAG_PP}${STUDY_SUFFIX}}"
PPB_TAG="${PPB_TAG_OVERRIDE:-${OFFICIAL_TAG_PPB}${STUDY_SUFFIX}}"
NMIX="${NMIX:-10}"

export SKIP_CLEAN=1
export CUT_PARALLELISM=1
# pp-only run: single skim file, 40 threads (≤55 cap)
...
# pp fully-corrected result (tag _20260603, MaxMixDeltaVZ=1 cm, with EE correction)
...
# pPb/PbP/MCGen legs deferred (already produced with _bin12x12_20260603)
