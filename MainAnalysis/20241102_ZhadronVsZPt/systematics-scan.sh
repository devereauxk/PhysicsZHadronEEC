...
#
# Orchestration knobs (set by run-scan-production.sh):
#   DOPP_SKIP_EE=1  — run all pp families except EEPrivate
#   DOPP_ONLY_EE=1  — run only pp EEPrivate (for the copy-skim slot)
#   PP_INPUT_OVERRIDE — alternate pp skim path (e.g. the -copy file)
#
# Usage: ./systematics-scan.sh <DOPP> <DOPPB> <DOPBP> [extra args...]
# Example: NTHREAD=30 ./systematics-scan.sh 1 1 1
