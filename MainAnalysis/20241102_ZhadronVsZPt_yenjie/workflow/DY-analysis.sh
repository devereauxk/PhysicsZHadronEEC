...
COMMON_ARGS="--UseLeadingTrk $UseLeadingTrk --Input mergedSample/DY-v10-trackPt05.root --MixFile mergedSample/DY-v10-trackPt05.root --IsPP false --IsGenZ false --nMix 10"
