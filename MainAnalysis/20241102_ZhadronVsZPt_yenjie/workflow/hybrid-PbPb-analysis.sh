...
source config.sh
COMMON_ARGS="--UseLeadingTrk $UseLeadingTrk --Input mergedSample/hybrid_PbPb030-v8.root --MixFile mergedSample/hybrid_PbPb030-v8.root --IsPP false --IsGenZ true --nMix 100 --MinHiBin 0 --MaxHiBin 600000"
