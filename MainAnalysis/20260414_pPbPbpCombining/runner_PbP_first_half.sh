...
export OUTPUT_DIR="${OUTPUT_DIR:-output/PbP_runlt${RUN_THRESHOLD}}"
...
export PPB_EXTRA_ARGS="${PPB_EXTRA_ARGS:-}"
export PBP_EXTRA_ARGS="${PBP_EXTRA_ARGS:---MaxRun ${RUN_THRESHOLD}}"
