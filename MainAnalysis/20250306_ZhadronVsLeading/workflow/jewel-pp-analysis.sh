...
source config.sh
COMMON_ARGS="--UseLeadingTrk $UseLeadingTrk --Input mergedSample/jewel_pp-v9.root --MixFile mergedSample/jewel_pp-v9.root --IsPP true --IsGenZ true --nMix 10 --MinHiBin 0 --MaxHiBin 600000"
